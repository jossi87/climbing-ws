...
Import the [latest database dump](https://github.com/jossi87/climbing-ws/blob/main/20260527.climbing-no-data.sql) and initialize the development environment:
> ```sh
> CREATE DATABASE IF NOT EXISTS climbing;
> USE climbing;
> SET autocommit=0; SOURCE ./20260527.climbing-no-data.sql; COMMIT;
...
> INSERT INTO grade_system VALUES (1, 'Climbing');
> INSERT INTO type_grade_system VALUES (1, 1);
> INSERT INTO grade_color VALUES (0, '#CCCCCC');
> INSERT INTO grade_color VALUES (6, '#FF0000');
> INSERT INTO grade (id, grade_system_id, grade, weight, label_major, label_compact, grade_color_id) VALUES (1, 1, 'n/a', 0, 'n/a', 'n/a', 0);
> INSERT INTO grade (id, grade_system_id, grade, weight, label_major, label_compact, grade_color_id) VALUES (2, 1, '8 (7b+)', 0, '8', '8', 6);
> COMMIT;
> ```
