...
Import the [latest database dump](https://github.com/jossi87/climbing-ws/blob/main/20260707.climbing-no-data.sql) and initialize the development environment:
> ```sh
> CREATE DATABASE IF NOT EXISTS climbing;
> USE climbing;
> SET autocommit=0; SOURCE ./20260707.climbing-no-data.sql; COMMIT;
