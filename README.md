...
2. Eclipse
	...
	- Edit buldreinfo.properties in "com.buldreinfo.jersey.jaxb.config". All values are required for the server to function, just add wathever you want to "auth0.secret"
	```
	db.hostname=localhost
	db.database=buldreinfo
	db.username=root
	db.password=YOUR_PASSWORD
	auth0.secret=Something
	```
3. Run Project
