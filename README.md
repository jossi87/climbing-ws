...
Import the [latest database dump](https://github.com/jossi87/climbing-ws/blob/main/20260504.climbing-no-data.sql) and initialize the development environment:
> ```sh
