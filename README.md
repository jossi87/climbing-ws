...
## :rocket: Onboarding
1. Database
	- Download the databasedump: https://github.com/jossi87/climbing-ws/blob/main/20230904-143933.buldreinfo.no-data.sql
	...
	USE buldreinfo;
	SET autocommit=0; SOURCE C:/temp/20230904-143933.buldreinfo.no-data.sql; COMMIT;
	-- Add dummy data
