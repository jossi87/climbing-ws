...
1. Database
	...
	ALTER TABLE `buldreinfo`.`problem` ADD COLUMN `broken` VARCHAR(255) AFTER `sector_id`; -- TODO Remove this when database (20230728-100208.buldreinfo.no-data.sql) is updated.
