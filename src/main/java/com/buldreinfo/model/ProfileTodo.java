...
public record ProfileTodo(List<ProfileTodoArea> areas) {
	...
	public record ProfileTodoProblem(int todoId, int id, boolean lockedAdmin, boolean lockedSuperadmin, int nr, String name, String grade, String subType, int numPitches, Coordinates coordinates, List<User> partners) {}
}