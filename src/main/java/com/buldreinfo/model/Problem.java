...
public record Problem(String redirectUrl, int areaId, boolean areaLockedAdmin, boolean areaLockedSuperadmin, String areaName, Coordinates areaCoordinates,
		...
		Coordinates sectorParking, List<Coordinates> sectorOutline, CompassDirection sectorOrientationCalculated, CompassDirection sectorOrientationManual,
