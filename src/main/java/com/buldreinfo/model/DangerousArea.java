...
public record DangerousArea(int id, String name, boolean lockedAdmin, boolean lockedSuperadmin, int sunFromHour, int sunToHour, List<DangerousSector> sectors) {
	public record DangerousSector(int id, String name, CompassDirection orientationCalculated, CompassDirection orientationManual, boolean lockedAdmin, boolean lockedSuperadmin, int sunFromHour, int sunToHour, List<DangerousProblem> problems) {}
